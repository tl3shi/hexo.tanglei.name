...
<pre>&lt;cc lang="bash" inline="true"> sudo apt-get install ntfs-config &lt;/cc></pre>

打开软件设置： 

<pre>&lt;cc lang="bash" inline="true"> sudo ntfs-config &lt;/cc></pre>
...
[<img style="display: inline; border: 0px;" title="NTFS 写入支持配置程序_011" src="http://www.tanglei.name/wp-content/uploads/2012/03/NTFS_011_thumb.jpg" alt="NTFS 写入支持配置程序_011" width="448" height="402" border="0" data-pinit="registered" />](http://www.tanglei.name/wp-content/uploads/2012/03/NTFS_011.jpg)
...
[<img style="display: inline; border: 0px;" title="image" src="http://www.tanglei.name/wp-content/uploads/2012/03/image_thumb5.png" alt="image" width="493" height="55" border="0" />](http://www.tanglei.name/wp-content/uploads/2012/03/image5.png)
